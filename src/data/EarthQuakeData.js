const earthQuakeData = {
  ...
  export const getEarthQuakeAllData = () => {
    return earthQuakeData.data;
  }

  export const getEarthQuakeProfile = () => {
      return earthQuakeData.profile;
  }

  export const getEarthQuakeSite = () => {
      return earthQuakeData.site;
  }

  export const getEarthQuakeDataById = (dataId) => {
    const len = earthQuakeData.data.features.length;
    for(let i = 0; i < len; i++){
      const { id } = earthQuakeData.data.features[i];
      if(id === dataId){
        return earthQuakeData.data.features[i];
      }  
    }
    return null;
  }